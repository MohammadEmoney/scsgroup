        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
            @foreach ($portfolios as $portfolio)
                <div class="col-lg-4 col-md-6 portfolio-item
                    @foreach($portfolio->categories()->get() as $category) {{ "filter-" . $category->name_en }} @endforeach
                    ">
                    <div class="portfolio-img"><img src="{{ $portfolio->getFirstMediaUrl('SpecialImage') }}"
                            class="img-fluid" alt=""></div>
                    <div class="portfolio-info">
                        <h4>{{ $portfolio->name_en }}</h4>
                        <p>App</p>
                        <a href="{{ $portfolio->getFirstMediaUrl('SpecialImage') }}"
                            data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="{{ $portfolio->name_en }}"><i
                                class="bx bx-plus"></i></a>
                        <a href="{{ route('portfolios.show', $portfolio->slug) }}" class="details-link" title="More Details"><i
...
{{--
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-img"><img src="{{ asset('front/assets/img/portfolio/portfolio-1.jpg') }}"
                        class="img-fluid" alt=""></div>
                <div class="portfolio-info">
                    <h4>App 1</h4>
                    <p>App</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                <div class="portfolio-img"><img src="{{ asset('front/assets/img/portfolio/portfolio-8.jpg') }}"
                        class="img-fluid" alt=""></div>
                <div class="portfolio-info">
                    <h4>Card 3</h4>
                    <p>Card</p>
